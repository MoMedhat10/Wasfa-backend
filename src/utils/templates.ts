...
export const generateResetPasswordEmailTemplate = (user: User, verificationToken: string) => {
    const link = `${process.env.CLIENT_DOMAIN}/users/${user.id}/reset-password/${verificationToken}`;
    const template = `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    <div style="background-color: #f97316; padding: 20px; text-align: center;">
                        <h1 style="color: white; margin: 0;">🍳 Wasfa</h1>
                    ...
                    <div style="padding: 30px; background-color: #f9f9f9;">
                        ...
                        <p style="color: #666; font-size: 14px;">
                            This reset password link will expire in 24 hours.
                        </p>
                    </div>
                    <div style="background-color: #333; padding: 20px; text-align: center;">
                        <p style="color: #999; margin: 0; font-size: 12px;">
